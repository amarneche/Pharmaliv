        ...
        <div class="col-md-12">
            <div>
                <ul class="nav nav-tabs">
                    ...
                    <li class="active" ><a  role="tab" data-toggle="tab">Medcin </a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" role="tabpanel" id="tab-2">
                            <h1>Ajouter un Medcin</h1>

                            <form method='post' >
                                    {{ csrf_field() }}
                                    <div class='col-sm-12'>
                                            <strong>information a propos du Medcin </strong>
                                    </div>
                                    <div class="col-sm-6 {!!$errors->has('nom') ?'has-error':''!!}">
                                        ...
                                        <div class='col-sm-12'>
                                                <strong>information a propos du cabinet</strong>
                                        </div>
                                        ...
                                        <div class="col-sm-3 {!!$errors->has('ouvreA') ?'has-error':''!!}">
                                            <input name='ouvreA'class="form-control" type="number" placeholder="Ouvre a " />
                                            {!!$errors->first('ouvreA',"<small class='help-block'>:message</small>")  !!}
                                        </div>
                                        <div class="col-sm-3 {!!$errors->has('fermeA') ?'has-error':''!!}">
                                            <input name='fermeA'class="form-control" type="number" placeholder="Ferme a" />
